...
import com.gt.bookshop.entity.Book;
import com.gt.bookshop.mapper.BookMapper;
...
public class BookService {
    ...
    public int getRecordCount(int categoryid) {
        ...
        return bookMap.getRecordCount(categoryid);
    }
    ...
    public List<Book> getNewBooks(int top) {
        ...
        return bookMap.getNewBooks(top);
    }
    ...
    {
        return bookMap.getHomeBooks(13);
    }
    ...
    public List<Book> getListByCategoryId(int categoryid) {
          return bookMap.getListByCategoryId(categoryid);
    }
