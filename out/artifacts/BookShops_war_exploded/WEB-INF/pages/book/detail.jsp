...
<div id="container">
  ...
  <div class="book_view">
    ...
    <dl class="put_book">
      <dt>
        <img src="/img/BookCovers/${book.ISBN}.jpg"
        alt="${book.ISBN}" />
      <div class="chakan">
    ...
    <div class="comm_answer">
        ...
        <div class="total_comm">
          ...
          <div class="total_body">
            ...
            <div class="write_comm">
              <a id="reviewTipa"  href="#"><img src="/img/button_write_comm.gif" border="0" title="写评论" /></a>
            </div>
      ...
      <div class="comm_list">
        <h3>
          <img src="/img/label_1.gif"  title="精彩评论" /><a href="#" target="_blank" name="reviewDetail">非常不错的一本书</a>
